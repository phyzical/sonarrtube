...
export const channelFactory = (params: object = {}, videoCount: undefined | number = undefined): Channel => new Channel(
    {
        videos: generateRandomArray(() => videoFactory(), videoCount, videoCount) as Video[],
